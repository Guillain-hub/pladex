            ...
            <div className="lg:col-span-5 mt-8 lg:mt-12">
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        className="relative bg-gradient-to-b from-[#071021]/60 to-[#071021]/40 border border-white/6 backdrop-blur-xl p-2 md:p-6 lg:p-8 rounded-2xl shadow-xl overflow-hidden max-w-full ml-auto"
                    >
